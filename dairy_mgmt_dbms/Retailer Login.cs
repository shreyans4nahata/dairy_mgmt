...
{
    public partial class FormRetailer : Form
    {
        public static int? r_id_g;
        public FormRetailer()
        {
            InitializeComponent();
            ...
            try
            {
                ...
                if (id != null && pass != null)
                {
                    ...
                    try
                    {
                        ...
                        cmd.Connection = conn;
                        cmd.CommandText = "SELECT r_id FROM retailer WHERE r_id = ?id AND pwd = ?pass ;";
                        cmd.Parameters.AddWithValue("?id", id);
                        cmd.Parameters.AddWithValue("?pass", pass);
                        Console.WriteLine("in1");
                        try
                        {
                            r_id_g = (int)(cmd.ExecuteScalar());
                        }
