...
{
    public partial class FormRetailerSign : Form
    {
        public FormRetailerSign()
        {
            InitializeComponent();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (id != null && pass != null && name != null && addr != null && amt != null)
                {
                    ...
                    try
                    {
                        ...
                        cmd.Connection = conn;
                        cmd.CommandText = "INSERT INTO retailer VALUES (?id, ?addr,?name,?amt, ?pass) ;";
